...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public NaturalNumber3(NaturalNumber n) {
        ...
        int sInt = Integer.parseInt(numAsString);
    ...
    public final int divideBy10() {
        ...
        if (this.rep.length() == 1) {
            ...
            String lastDig = "" + this.rep.charAt(this.rep.length() - 1);
            remainder = Integer.parseInt(lastDig);
            this.rep = "";

        } else if (!this.rep.isEmpty()) {
